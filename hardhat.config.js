...
module.exports = {
  ...
  networks: {
    ...
    polygon_mumbai: {
      ...
      accounts: [`0x${process.env.PRIVATE_KEY_LIR_TESTNET}`,`0x${process.env.PRIVATE_KEY_LIR_2}`, `0x${process.env.PRIVATE_KEY_LIR_TESTNET_BACKUP}`, `0x${process.env.PRIVATE_KEY_LIR}`] 
    },
    // polygon_mainnet: {
