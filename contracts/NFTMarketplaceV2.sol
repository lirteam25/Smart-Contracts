...
contract NFTMarketplaceUpgradableV2 is ERC1155HolderUpgradeable {
    ...
    */
    ...
    /* GASLESS TRANSACTION FUNCTIONS FOR SALES WITH PRICE EQUAL TO ZERO*/
    ...
    function GasFreeTransaction(
	   ...
	   address tokenBuyer
        ...
        require(
            price==0,
            "Price must be zero to get a gas-free transaction"
        );
        ...
        // 4)
        NFTMint.safeTransferFrom(tokenSeller, tokenBuyer, tokenId, 1, "");
        // 5)
        updateIdToOwner(tokenId, contractAddress, tokenSeller);
